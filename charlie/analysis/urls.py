...
urlpatterns = patterns('',
    ...
    url(r'^(?P<datasource_id>\d+)/repName/$', views.replaceNames, name='replaceNames'),
    url(r'^(?P<datasource_id>\d+)/remSkip/$', views.removeSkipWords, name='remSkips'),
    url(r'^(?P<datasource_id>\d+)/remSin/$', views.removeSingleLetterMsgs, name='remSins'),
    url(r'^(?P<datasource_id>\d+)/remNum/$', views.removeNumbers, name='remNums'),
    url(r'^(?P<datasource_id>\d+)/repSlang/$', views.replaceSlang, name='repSlang'),
    url(r'^(?P<datasource_id>\d+)/doAll/$', views.doAll, name='doAll'),
